...
// curl 获取内容
$content = curl('https://www.360kan.com/dianshi/list.php?cat='.$cat.'&area='.$area.'&year='.$year.'&act='.$act.'&pageno='.$pageno);
    ...
    <div class="am-u-md-3">
        ...
        <select placeholder="类型" name="cat" data-am-selected="{btnWidth: '100%', maxHeight: 225}" 
         class="filter-change-listen" id="movie-cat">
            ...
            <option value="101">言情</option>
            <option value="105">伦理</option>
            <option value="109">喜剧</option>
            <option value="108">悬疑</option>
            <option value="111">都市</option>
            <option value="100">偶像</option>
            <option value="104">古装</option>
            <option value="107">军事</option>
            <option value="103">警匪</option>
            <option value="112">历史</option>
            <option value="106">武侠</option>
            <option value="113">科幻</option>
            <option value="102">宫廷</option>
            <option value="114">情景</option>
            <option value="115">动作</option>
            <option value="116">励志</option>
            <option value="117">神话</option>
            <option value="118">谍战</option>
            <option value="110">粤语</option>
