...
// curl 获取内容
$content = curl('https://www.360kan.com/dianying/list.php?cat='.$cat.'&area='.$area.'&year='.$year.'&act='.$act.'&pageno='.$pageno);
